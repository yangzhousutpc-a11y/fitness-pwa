...
const exerciseImageUrls: Record<string, string> = {
  ...
  'hip-adduction-machine': '/coach-shots/hip-adduction-cue.jpg',
  ...
  'leg-curl': '/coach-shots/prone-leg-curl-cue.jpg',
  'seated-hip-flexion-raise': '/coach-shots/seated-hip-flexion-raise-cue.jpg',
...
const exerciseProfileGoals: Record<string, string> = {
  ...
  'hip-adduction-machine': '用内收机补大腿内侧和髋关节控制，让下肢和躯干收紧能力更完整。',
  'single-leg-deadlift': '用单腿硬拉开发髋关节能力和单腿骨盆稳定，服务腿日后侧链训练。',
  'deadlift': '用传统硬拉整合腿、臀、背和握力，训练从地面发力的全身张力。',
  'seated-hip-flexion-raise': '用坐姿屈髋抬腿补股直肌靠近髋部的发力，强化大腿前侧根部控制。',
